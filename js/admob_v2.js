    ...
    try {
      ...
      if (s.bid) {
        $.ajax({
          ...
          data: {
            __ar: '{"1":"' + s.name + '","2": 1,"3": {"1": ' + self.operation_system + ', "2": ' + type + ', "3": ["' + adunitId + '"]},"4": [{"2": 1, "3": 1, "4": 2, "5": {"1": "' + s.bid + '", "2": "USD"}, "6": true}]}'
          },
          async: false,
        ...
        $.ajax({
          ...
          url: 'https://apps.admob.com/inventory/_/rpc/MediationGroupService/Create?rpcTrackingId=MediationGroupService.Create:1',
          data: {
            __ar: '{"1":"' + s.name + '","2": 1, "3": {"1": ' + self.operation_system + ', "2": ' + type + ', "3": ["' + adunitId + '"]},"4": [{"2": 1, "3": 1, "4": 2, "5": {"1": "10000", "2": "USD"}, "6": true}]}'
          },
          async: false,
          contentType: 'application/x-www-form-urlencoded',
          headers: {
