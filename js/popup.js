...
LoadController = (function () {
    ...
    checking_plugin_version = function (items) {
        if (extensionVersion() < items.plugin_critical_version ) {
            chrome.runtime.sendMessage({type: "update_plugin", info: 'Please update Chrome extension from version '+ items.plugin_critical_version, title: 'Update Chrome extension'}, function(id){});
            return false
        }
        return true;
    };
